      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <div className="text-gray-700 font-semibold">Gia đình hạnh phúc</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-gray-700 font-semibold">Tỷ lệ hài lòng</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-gray-700 font-semibold">Nhiệm vụ đã hoàn thành</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-gray-700 font-semibold">Đánh giá trung bình</div>
          </div>
        </div>
      </div>
    </section>
